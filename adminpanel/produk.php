...
$queryTambah = mysqli_query($con, "INSERT INTO produk(kategori_id, nama, harga, foto, detail, ketersediaan_stok)VALUES ('$kategori', '$nama', '$harga', '$new_name', '$detail', '$stok')"); 

if($queryTambah){
  ?>
  <div class="alert alert-primary mt-3" role="alert">Produk Berhasil Ditambahkan</div>
...
<div class="mt-3">
  ...
  <table class="table">
    ...
    <tbody>
      <?php
      if($jumlahProduk == 0){?>
        <tr><td colspan="5" class="text-center">Tidak ada data Produk</td></tr><?php
      } else{
        $jumlah = 1;
        while($data = mysqli_fetch_array($query)){
          ...
          <tr>
            ...
            <td><a href="produk-detail.php?p=<?php echo $data['id'];?>" class="btn btn-info"><i class="bi bi-search"></i></a></td>
          </tr>
